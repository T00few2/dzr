// SOURCE OF TRUTH. Do not edit apps/bot/services/coachChatNotes.js directly.
//
// Copied into apps/bot by `npm run sync:shared`; the Next.js site imports the goal helpers from
// here via app/lib/coachGoals.ts. CI fails on drift.
//
// Most of this module is bot-only (prompt formatting, extraction prompts, retrieval scoring).
// The part both runtimes depend on is goal validity — sanitizeEventDate and activeGoalNotes —
// which decides whether a member's goal is still live and therefore whether the coach steers
