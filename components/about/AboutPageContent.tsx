      ...
      <VStack spacing={12} align="stretch">
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
          <Box textAlign="center">
            ...
            <Button as="a" href="/about/racing" variant="link" color="#ad1a2d" fontSize="sm" mt={2}>
              Læs mere om klub-løb
            </Button>
          </Box>
          <Box textAlign="center">
          ...
          <Card bg="gray.800" borderColor="#ad1a2d" borderWidth="2px" h="full" overflow="hidden">
            ...
            <CardBody>
              <List spacing={2} color="white">
                ...
                <ListItem fontSize="sm">• Adgang til DCU E-Serien som medlem af en DCU-klub (DZR)</ListItem>
