    ...
    >
      ...
      <Box width={'100%'}>
        <SimpleGrid spacing={4} minChildWidth={{ base: '100%', sm: '280px' }} marginBlockEnd={4}>
          ...
          <CustomCard href='/about' icon={MdInfo} heading='About DZR' text1='Learn about our community' text2='& memberships.' />
          <CustomCard href='puncheurs-summer-cup' icon = {RiBoxingFill} heading = 'Puncheurs Summer Cup' text1 = 'Puncheurs Summer Battle' text2= 'Tuesdays in June 19:25 CEST | 1:25 PM EDT' />
          ...
          <CustomCard href='the-zwifty-fifty' icon={Im500Px} heading='The Zwifty Fifty' text1='50km (ish) races with sprints for bonus seconds' text2='Sundays 14:45 CET | 8:45 AM EST' />
        </SimpleGrid>
      </Box>
    </Container>
  )
