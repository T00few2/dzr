...
<Tooltip label = " 6:00min ramp from 52% to 70%">
        <path d="M 123.5416688278008 0 L 123.5416688278008 51.930803000000004 L 168.04166736918972 69.999993 L 168.04166736918972 0 0 Z" fill="grey" stroke="grey" />
        </Tooltip>
...
<Tooltip label = " 7:00min ramp from 60% to 70%">
        <path d="M 194.29166911210632 0 L 194.29166911210632 60.000001999999995 L 246.20833778539327 69.999993 L 246.20833778539327 0 0 Z" fill="blue" stroke="blue" />
        </Tooltip>
<Tooltip label = " 7:00min ramp from 60% to 75%">
        <path d="M 248.20833778539327 0 L 248.20833778539327 60.000001999999995 L 300.125002750347 75.0 L 300.125002750347 0 0 Z" fill="blue" stroke="blue" />
        </Tooltip>
...
<Tooltip label = " 6:30min ramp from 65% to 75%">
        <path d="M 341.2083348681711 0 L 341.2083348681711 65.14999900000001 L 389.4166666213424 75.150001 L 389.4166666213424 0 0 Z" fill="grey" stroke="grey" />
        </Tooltip>
...
<Tooltip label = " 3:00min ramp from 65% to 50%">
        <path d="M 975.7499982570835 0 L 975.7499982570835 64.999998 L 998.0000000000001 50.0 L 998.0000000000001 0 0 Z" fill="grey" stroke="grey" />
        </Tooltip></svg></Box></div>);